        ...
        <div className="relative flex w-full min-h-screen bg-grey-50">
            ...
            <div className="flex flex-col w-full">
                ...
                <div className="relative md:w-full max-w-2xl xl:max-w-5xl self-center text-grey-800 sm:ml-[6.5rem] flex flex-col p-8">
                    ...
                    <h2 className="text-3xl font-semibold mt-6 text-primary-500">{item.name}</h2>
                    <p className="text-grey-500">{truncateString(item.description, 300)}</p>

                    <div className="flex gap-4 mt-2">
                        <Link to={`/dashboard/funds/buy/${item.id}`} className="flex items-center gap-2 text-grey-500">
                            <Button className="font-semibold border rounded-sm bg-grey-200 text-grey-800" variant="solid">Buy Fund</Button>
                        </Link>
                                ...
                                <CardBody className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                    <div className="flex items-center w-full gap-3">
                                        ...
                                        <div className="text-sm">
                                            ...
                                            <p className="text-grey-500">$10140.56</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center w-full gap-3">
                                        ...
                                        <div className="text-sm">
                                            ...
                                            <p className="text-grey-500">$2140.56</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center w-full gap-3">
                                        ...
                                        <div className="text-sm">
                                            <h3 className="font-semibold">BRETT</h3>
                                            <p className="text-grey-500">$9.56</p>
                                        </div>
                                    </div>
